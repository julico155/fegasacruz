// resources/js/Pages/MySales/Index.vue
<script setup>
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Mis Compras</h2>
        </template>

        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 rounded-lg shadow-lg">
                    <h3 class="text-xl font-semibold mb-6 text-gray-800">Mi Historial de Compras</h3>

                    <div v-if="ventas.data.length === 0" class="text-center py-10 text-gray-600">
                        <p class="text-lg mb-4">Aún no has realizado ninguna compra.</p>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 rounded-lg overflow-hidden">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="venta in ventas.data" :key="venta.id">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        ${{ ensureFloat(venta.total).toFixed(2) }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <span :class="[
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <!-- Reutilizamos la vista Admin/Sales/Show para mostrar los detalles -->
