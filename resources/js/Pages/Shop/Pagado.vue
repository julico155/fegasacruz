        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <h1 class="text-2xl font-bold text-center mt-5 py-3">Pedido pagado exitosamente</h1>
                    <div class="flex justify-center">
                        <svg fill="#000000" height="500px" width="300px" version="1.1" id="Capa_1"
            ...
            S509.502,87.794,504.969,83.262z" />
                    ...
                    <h2 class="font-bold text-center mb-5 py-3">¡GRACIAS POR SU PREFERENCIA!</h2>
                </div>
            </div>
        </div>
    </AuthenticatedLayout>
